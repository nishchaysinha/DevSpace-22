...
<div align="left">
  ...
  Our solution integrates some of the most essential tools like realtime drawing boards, voicechat with transcription(using [Symbl.ai](https://symbl.ai/)), inbuilt realtime code editors and compilers for prototyping and an inbuilt document editor.
...
<div>
  -We've prototyped the user interface(Created in Figma)
